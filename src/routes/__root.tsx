...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A community welfare organisation supporting healthcare workers across Kirinyaga County through unity, mutual support, and social growth." },
