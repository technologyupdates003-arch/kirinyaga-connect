...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/about' | '/admin' | '/contact' | '/events' | '/gallery' | '/login' | '/membership' | '/register' | '/team'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/about' | '/admin' | '/contact' | '/events' | '/gallery' | '/login' | '/membership' | '/register' | '/team'
  id: '__root__' | '/' | '/about' | '/admin' | '/contact' | '/events' | '/gallery' | '/login' | '/membership' | '/register' | '/team'
...
const rootRouteChildren: RootRouteChildren = {
  IndexRoute, AboutRoute, AdminRoute, ContactRoute, EventsRoute, GalleryRoute, LoginRoute, MembershipRoute, RegisterRoute, TeamRoute,
}
